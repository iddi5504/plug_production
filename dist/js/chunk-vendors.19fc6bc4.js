 ...
 * limitations under the License.
 */
class vh{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class yh extends Zl{constructor(t,e,n,r,i,o){super(t,e,n,r,o),this._firestore=t,this._firestoreImpl=t,this.metadata=i}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new _h(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const n=this._document.data.field(eh("DocumentSnapshot.get",t));if(null!==n)return this._userDataWriter.convertValue(n,e.serverTimestamps)}}}class _h extends yh{data(t={}){return super.data(t)}}class wh{constructor(t,e,n,r){this._firestore=t,this._userDataWriter=e,this._snapshot=r,this.metadata=new vh(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){const t=[];return this.forEach((e=>t.push(e))),t}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(t,e){this._snapshot.docs.forEach((n=>{t.call(e,new _h(this._firestore,this._userDataWriter,n.key,n,new vh(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))}))}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new $r(Fr.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(t,e){if(t._snapshot.oldDocs.isEmpty()){let e=0;return t._snapshot.docChanges.map((n=>{const r=new _h(t._firestore,t._userDataWriter,n.doc.key,n.doc,new vh(t._snapshot.mutatedKeys.has(n.doc.key),t._snapshot.fromCache),t.query.converter);return n.doc,{type:"added",doc:r,oldIndex:-1,newIndex:e++}}))}{let n=t._snapshot.oldDocs;return t._snapshot.docChanges.filter((t=>e||3!==t.type)).map((e=>{const r=new _h(t._firestore,t._userDataWriter,e.doc.key,e.doc,new vh(t._snapshot.mutatedKeys.has(e.doc.key),t._snapshot.fromCache),t.query.converter);let i=-1,o=-1;return 0!==e.type&&(i=n.indexOf(e.doc.key),n=n.delete(e.doc.key)),1!==e.type&&(n=n.add(e.doc),o=n.indexOf(e.doc.key)),{type:bh(e.type),doc:r,oldIndex:i,newIndex:o}}))}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}}function bh(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return Mr()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Eh(t){t=Zc(t,il);const e=Zc(t.firestore,bl);return yl(Il(e),t._key).then((n=>xh(e,t,n)))}class Ih extends gh{constructor(t){super(),this.firestore=t}convertBytes(t){return new Sl(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new il(this.firestore,null,e)}}function Th(t){t=Zc(t,ol);const e=Zc(t.firestore,bl),n=Il(e),r=new Ih(e);return nh(t._query),_l(n,t._query).then((n=>new wh(e,r,t,n)))}function Sh(t,e,n){t=Zc(t,il);const r=Zc(t.firestore,bl),i=mh(t.converter,e,n);return Oh(r,[Ml(Pl(r),"setDoc",t._key,i,null!==t.converter,n).toMutation(t._key,as.none())])}function kh(t,e,n,...r){t=Zc(t,il);const i=Zc(t.firestore,bl),o=Pl(i);let s;return s="string"==typeof(e=(0,a.m9)(e))||e instanceof kl?Bl(o,"updateDoc",t._key,e,n,r):Vl(o,"updateDoc",t._key,e),Oh(i,[s.toMutation(t._key,as.exists(!0))])}function Ch(t){return Oh(Zc(t.firestore,bl),[new ws(t._key,as.none())])}function Ah(t,e){const n=Zc(t.firestore,bl),r=cl(t),i=mh(t.converter,e);return Oh(n,[Ml(Pl(t.firestore),"addDoc",r._key,i,null!==t.converter,{}).toMutation(r._key,as.exists(!1))]).then((()=>r))}function Oh(t,e){return function(t,e){const n=new Vr;return t.asyncQueue.enqueueAndForget((async()=>Ac(await ml(t),e,n))),n.promise}(Il(t),e)}function xh(t,e,n){const r=n.docs.get(e._key),i=new Ih(t);return new yh(t,i,e._key,r,new vh(n.hasPendingWrites,n.fromCache),e.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rh(){return new Fl("serverTimestamp")}function Nh(...t){return new $l("arrayUnion",t)}!function(t,e=!0){!function(t){Or=t}(i.Jn),(0,i.Xd)(new o.wA("firestore",((t,{instanceIdentifier:n,options:r})=>{const i=t.getProvider("app").getImmediate(),o=new bl(new Hr(t.getProvider("auth-internal")),new Qr(t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new $r(Fr.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Mi(t.options.projectId,e)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.19fc6bc4.js.map