 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function De(){return window}function Le(t){De().location.href=t}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pe(){return"undefined"!==typeof De()["WorkerGlobalScope"]&&"function"===typeof De()["importScripts"]}async function Me(){if(!(null===navigator||void 0===navigator?void 0:navigator.serviceWorker))return null;try{const t=await navigator.serviceWorker.ready;return t.active}catch(t){return null}}function Ue(){var t;return(null===(t=null===navigator||void 0===navigator?void 0:navigator.serviceWorker)||void 0===t?void 0:t.controller)||null}function Fe(){return Pe()?self:null}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function In(t,e,n=!1){const r=Ct(t),i=un(r,e),s=new wn(r,i,n),o=await s.execute();return o&&!n&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pn=new O(3e4,6e4);function Mn(){const t=De().___jsl;if(null===t||void 0===t?void 0:t.H)for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}function Un(t){return new Promise(((e,n)=>{var r,i,s;function o(){Mn(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Mn(),n(p(t,"network-request-failed"))},timeout:Pn.get()})}if(null===(i=null===(r=De().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)e(gapi.iframes.getContext());else{if(!(null===(s=De().gapi)||void 0===s?void 0:s.load)){const e=sn("iframefcb");return De()[e]=()=>{gapi.load?o():n(p(t,"network-request-failed"))},rn(`https://apis.google.com/js/api.js?onload=${e}`).catch((t=>n(t)))}o()}})).catch((t=>{throw Fn=null,t}))}let Fn=null;function Vn(t){return Fn=Fn||Un(t),Fn}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
...
//# sourceMappingURL=chunk-vendors.31ebba28.js.map