                ...
                <ul v-show="shownavoptions" id="dropdownlist" class="nav justify-content-end">
                    <li class="nav-item navitems">
                        <router-link style="flex-direction: column;"  to="/profile">
                            <div style="">
                                <i class="fa-solid fa-user" style="color:var(--textcolorimportant);"></i>
                    ...
                    <li @click="togglelightmode" class="nav-item navitems">
                        <a type="button" class="nav-link">
                            <i class="bi bi-brightness-high"></i><small id="light" class="dropdowntext">light
                                mode</small>
                        </a>
                    </li>
                    <li class="nav-item navitems">
                    ...
                    <li class="nav-item navitems" @click="logout">
                        <a class="nav-link" style="color: red" tabindex="-1" aria-disabled="true"><i
                                class="bi bi-door-open"></i><small class="dropdowntext">Logout</small></a>
                    </li>
                </ul>
            </transition>
